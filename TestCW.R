...
data <- read_excel("D:\\IIT\\Level5\\Sem2\\Machine Learning and Data Mining\\Assignmentx\\vehicles.xslx")
...
kmeans3
fviz_cluster(kmeans3, data = scaled_df, stand = FALSE, geom = "point", 
...
kmeans2
fviz_cluster(kmeans2, data = scaled_df, stand = FALSE, geom = "point", 
             palette = "jco", ggtheme = theme_minimal())
